...
/**There are some typically constants for event handling from client*/
...
#define CONNECTED_WEB_CLIENT    5                       //that for event, that says that we have a new connected web-client
#define DISCONNECTED_WEB_CLIENT 6                       //that for event, that says that we have a disconnected web-client
